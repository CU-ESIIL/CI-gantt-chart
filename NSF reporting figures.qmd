...
tasks_individual <- data.frame(
  Task = c("Community Needs Assessment", "Deploy IMGspec on Cyverse", "Deploy Own Instances Using CACAO",
           ...
           "Add Functionality to DE", "OASIS Cyberinfrastructure", "New and Recorded Trainings for Sustainable Scaling Up", 
           "Advanced Docker Containers", "Community Support & Guidance on NSF CI Resources", "Access Allocations (ACCESS-NSF)", 
  ...
  Start = as.Date(c("2022-08-01", "2022-08-01", "2022-08-01", "2023-01-01", "2023-06-01", "2023-06-01",
                    ...
                    "2024-08-01", "2024-12-01", "2025-01-01", "2025-01-01", "2025-01-01", "2025-01-01", 
  ...
  Color = rep('rgb(204,255,102)', 21)  # Light Lime Green
)
...
tasks_group <- data.frame(
  Task = c("Build Internal Documentation", "Move Education Classes to GitHub", "Push Adoption of GitHub",
           ...
           "Use Event Template for Innovation Summit 2024", "Use Event Template for HYR-SENSE Workshop",
           "Use Event Template for Hackathon", "Use Event Template for Innovation Summit 2025",
           "OASIS Cyberinfrastructure", "OASIS Main Page", "Data Registry, Analytics, and Education Repositories"),
  Start = as.Date(c("2022-08-01", "2023-01-01", "2023-02-01", "2023-02-01", "2023-10-01", "2023-11-01",
                    ...
                    "2025-05-01", "2025-01-01", "2025-01-01", "2025-01-01")),
  End = as.Date(c("2023-01-01", "2023-02-01", "2023-10-01", "2023-10-01", "2023-10-31", "2023-11-30",
                  ...
                  "2025-05-31", "2025-06-30", "2025-06-30", "2025-06-30")),
  Color = rep('rgb(153,255,51)', 16)  # Medium Lime Green
)
...
fig <- subplot(fig_individual, fig_group, fig_education, fig_user_portal, nrows = 4, shareX = TRUE, heights = c(0.25, 0.25, 0.30, 0.20))

fig <- fig %>% layout(
  height = 2000,  # Increase the height to ensure all tasks are visible
  width = 1500,
  paper_bgcolor = 'rgba(0,0,0,0)',  # transparent background
  plot_bgcolor = 'rgba(0,0,0,0)',  # transparent background
  xaxis = list(
